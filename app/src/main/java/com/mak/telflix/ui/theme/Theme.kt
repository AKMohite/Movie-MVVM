...
internal fun isContrastAvailable(): Boolean {
    return Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE
}

/**
 * Reference: [Jetpack Compose: Apply color contrast dynamically based on system](https://stackoverflow.com/a/79262234)
 */
@Composable
fun selectSchemeForContrast(isDark: Boolean): ColorScheme {
    ...
    if (!isPreview && isContrastAvailable()) {
        ...
        val contrastLevel = uiModeManager?.contrast ?: run {
            return if (isDark)
